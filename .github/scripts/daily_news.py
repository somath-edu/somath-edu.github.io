...
# 오늘 날짜로 파일명 깔끔하게 정리 (예: 2026-02-20-suneung...)
...
[엄격한 규칙]
1. 최상단 Front Matter에 `layout: newspaper`를 지정하고, permalink 끝에 '-en'을 붙이세요. (예: /{today}-suneung-ko-en)
...
print("✅ 3가지 버전의 신문 발행이 체계적으로 완료되었습니다.")
